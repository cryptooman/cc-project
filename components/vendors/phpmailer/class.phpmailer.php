...
// NOTE:
//		Class is hacked.
//		Removed -f option from sprintf()
//		Caused error: "Could not instantiate mail function"
 ...
 */
  ...
  protected function SendmailSend($header, $body) {
    if ($this->Sender != '') {
      $sendmail = sprintf("%s -oi %s -t", escapeshellcmd($this->Sendmail), escapeshellarg($this->Sender));
    } else {
  ...
  protected function MailSend($header, $body) {
    ...
    $params = sprintf("-oi %s", $this->Sender);
