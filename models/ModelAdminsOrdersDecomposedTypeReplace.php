 ...
 *
 */
class ModelAdminsOrdersDecomposedTypeReplace extends ModelAbstractAdminsOrdersDecomposed
{
    protected $_table = 'adminsOrdersDecomposedTypeReplace';
    ...
    function __construct()
    {
        $this->_fields = [
            ...
            'replaceOrderDecomposedId'  => [ Vars::UBIGINT, [1] ],
    ...
    function insert(int $orderId, array $orders)
    {
        ...
        $replaceOrderDecomposedIdsSeen = [];
        foreach ($orders as &$order) {
            if (isset($replaceOrderDecomposedIdsSeen[$order['replaceOrderDecomposedId']])) {
                throw new Err("Already seen replaceOrderDecomposedId [%s]", $order['replaceOrderDecomposedId']);
            }
            $replaceOrderDecomposedIdsSeen[$order['replaceOrderDecomposedId']] = true;
