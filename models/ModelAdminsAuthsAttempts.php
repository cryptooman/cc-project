 ...
 *
 */
class ModelAdminsAuthsAttempts extends ModelAbstractAuthsAttempts
{
    protected $_table = 'adminsAuthsAttempts';
    ...
    function insert(string $hash, string $email, string $ip, string $browserStr): int
    {
        return $this->_insert(
            ...
            Config::get('admin.auth.limits.attemptRowExpireMinutes')
        );
    }
}